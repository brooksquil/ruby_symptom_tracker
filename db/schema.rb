...
ActiveRecord::Schema[8.1].define(version: 2026_05_26_052724) do
  ...
  create_table "symptoms", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.index ["normalized_name"], name: "index_global_symptoms_on_normalized_name", unique: true, where: "(user_id IS NULL)"
    t.index ["user_id", "normalized_name"], name: "index_user_symptoms_on_user_and_normalized_name", unique: true, where: "(user_id IS NOT NULL)"
